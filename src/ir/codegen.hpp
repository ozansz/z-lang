...
public:
    ...
    virtual antlrcpp::Any visitFunction_identifier(ZParser::Function_identifierContext *context);
    virtual antlrcpp::Any visitFunction_call_arg_list(ZParser::Function_call_arg_listContext *context);
    ...
    virtual antlrcpp::Any visitConditional_operator(ZParser::Conditional_operatorContext *context);
    virtual antlrcpp::Any visitConditional_operand(ZParser::Conditional_operandContext *context);
    ...
    virtual antlrcpp::Any visitLambda_identifier(ZParser::Lambda_identifierContext *context);
    virtual antlrcpp::Any visitLambda_param_list(ZParser::Lambda_param_listContext *context);
    virtual antlrcpp::Any visitLambda_param(ZParser::Lambda_paramContext *context);
    virtual antlrcpp::Any visitLambda_param_integer(ZParser::Lambda_param_integerContext *context);
    virtual antlrcpp::Any visitLambda_param_set(ZParser::Lambda_param_setContext *context);
